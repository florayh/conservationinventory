...
# mannually transpose and combine with WDPA matrix in Excel. used those instead of t1 & t2 in the manuscript. 
...
```{r}
biomeArea <- sum(biome_by_ctr$area_geo)  #excluding area that did not overlap with country polygons
